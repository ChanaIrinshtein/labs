...
// contract FuzzTestStake is Test {
...
//     }
//     function FuzztestDeposit( uint sum) public {
//         // uint256 sum = 100 * wad;
...
//     function testNotWithdraw( uint sum) public {
//         // uint256 sum = 200 * wad;
//         require ( sum>0, "You cannot withdraw zero or less");
//         myCoin.mint(address(this), sum);
//         myCoin.approve(address(stake),sum);
//         stake.deposit(sum);
//         uint256 balanceBefore = stake.amount();
...
//     function testWithdraw( uint sum) public {
//     //    uint256 sum = 100 * wad;
//        require ( sum>0, "You cannot withdraw zero or less");
//        myCoin.mint(address(this), sum);
//        myCoin.approve(address(stake),sum);
